...
class CatsControllerTest < ActionController::TestCase
  ...
  test "should create cat" do
    assert_difference('Cat.count') do
      post :create, cat: { color: @cat.color, gender: @cat.gender, image: @cat.image, name: @cat.name, race: @cat.race }
    end
  ...
  test "should update cat" do
    patch :update, id: @cat, cat: { color: @cat.color, gender: @cat.gender, image: @cat.image, name: @cat.name, race: @cat.race }
    assert_redirected_to cat_path(assigns(:cat))
  end
